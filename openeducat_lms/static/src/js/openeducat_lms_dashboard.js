odoo.define('openeducat_lms.openeducat_lms_dashboard', function(require) {
    ...
    var LmsDashboard = Widget.extend({
        ...
        render_lms_dashboard: function() {
            ...
            self.rpc('/openeducat_lms/fetch_course', {}).done(function(result) {
                self.$el.html(QWeb.render('OpenEduCatLMSDashboard', {
                    course_ids: result.course_ids
                }));

                self.rpc('/openeducat_lms/compute_openeducat_graph', {}).done(function(result) {
        ...
        render_course_dashboard_data: function() {
            ...
            self.rpc('/openeducat_lms/get_lms_dash_data', {
                course_id: sel.value
            ...
            self.rpc('/openeducat_lms/compute_openeducat_course_graph', {
                course_id: sel.value
            }).done(function(result) {
