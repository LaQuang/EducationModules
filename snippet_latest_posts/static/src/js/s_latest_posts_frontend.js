    ...
    s_animation.registry.js_get_posts = s_animation.Class.extend({
        ...
        build: function (debug) {
            var self     = this,
                ...
                //tag_ids  = self.$target.data("filter_by_tag_id"),
                tag_id  = self.$target.data("filter_by_tag_id"),
            ...
            /*if (tag_ids) {
                ...
                domain.push(['tag_ids.id', 'in', tag_ids.split(',')]); 
            }*/
            if (tag_id) {domain.push(['tag_ids.id', '=', parseInt(tag_id)]); }
